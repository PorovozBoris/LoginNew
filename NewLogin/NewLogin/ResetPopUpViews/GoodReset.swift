...
struct GoodReset: View {
    @Binding var goodReset: Bool
    ...
    var body: some View {
        ...
        .ignoresSafeArea(.all)
        .background(Color.black.opacity(goodReset ? 0.3 : 0).blur(radius: 90))
        .ignoresSafeArea(.all)
    }
}

struct GoodReset_Previews: PreviewProvider {
    static var previews: some View {
        GoodReset(goodReset: .constant(true), showToggleReset: .constant(false), showToggleLogin: .constant(false))
    }
}
